...
# Spends the ISOLATED wallet funded by e2e-l1-to-l2.sh — shared "e2e-suite"
# store subdir. Never touches the proxy's sqlite store.
...
log "Step 1/5: Creating B2AGG bridge-out note (isolated client)..."
iso_tool \
