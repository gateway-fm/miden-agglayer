...
use super::{
    ...
    QueueOutcome, QueuedTxn, Store, TxnData, TxnEntry, UnbridgeableBridgeOut, UnclaimableClaim,
};
...
pub struct InMemoryStore {
    ...
    // Field-backed mirror of the PgStore `queued_txns` table (migration 019).
