...
const MIGRATIONS: &[(&str, &str)] = &[
    ...
    (
        "012_l1_finalized_block.sql",
        include_str!("../../migrations/012_l1_finalized_block.sql"),
    ),
    (
        "013_finalized_verified.sql",
        include_str!("../../migrations/013_finalized_verified.sql"),
    ),
];
